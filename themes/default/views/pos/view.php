                ...
                <?php
                    ...
                    if(is_array($rows)){
                        foreach ($rows as $row) {
                            ...
                            if ($row->item_tax != 0 ) {
                                echo '<td style="width: 100px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 ? '<small>(' . $this->erp->formatDecimal($row->tax_rate) . '%)</small>' : '') . $this->erp->formatMoney($row->item_tax) . '</td>';
                            }
