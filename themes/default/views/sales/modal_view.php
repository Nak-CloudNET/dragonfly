            ...
            <div class="row" style="margin-bottom:15px;">
                ...
                <div class="col-xs-6">
                    <?php echo $this->lang->line("to"); ?>:<br/>
                     <?php if(isset($customer->company) || isset($customer->names)){ ?>
                        <h2 style="margin-top:10px;"><?= $customer->company ? $customer->company : $customer->names; ?></h2>
                    <?php } ?>
                    <?php
                    ...
                    <div class="btn-group btn-group-justified">
						...
						<div class="btn-group">
                            <a href="<?= site_url('sales/print_w_a5/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('print_w_a5') ?>">
                                <i class="fa fa-print"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('Print_Digital') ?></span>
                            </a>
                        </div>
						<!--
                        <div class="btn-group">
