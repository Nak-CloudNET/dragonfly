...
class Products extends MY_Controller
{
    ...
    function deleteProductVariant($product_id=null,$variants_id=null){
		...
		$row1=$this->db->get_where('erp_warehouses_products_variants',array('option_id'=>$variants_id));
		...
		if($variants_id!=null){
			...
			if($exist->num_rows() > 0){
				...
				if($row->num_rows() >0 && $row1->num_rows()>0){
					...
					$this->db->delete('warehouses_products_variants',array('option_id'=>$variants_id));
					echo true;
				}
